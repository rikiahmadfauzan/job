    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
            ...
            <nav class="vertnav navbar navbar-light">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    {{-- <li class="nav-item w-100 {{ Request::is('admin-ajukan') ? 'active' : '' }}">
                        <a class="nav-link {{ Request::is('admin-ajukan') ? 'active' : '' }}" href="/admin-ajukan">
                            <i class="fe fe-check-circle fe-16"></i>
                            <span class="ml-3 item-text">Loker</span>
                        </a>
                    </li> --}}
                    <li class="nav-item w-100 {{ Request::is('daftar') ? 'active' : '' }}">
                        <a class="nav-link {{ Request::is('daftar') ? 'active' : '' }}" href="/daftar">
                            <i class="fe fe-file fe-16"></i>
                            <span class="ml-3 item-text">Daftar</span>
                        </a>
                    </li>
                    <li class="nav-item w-100 {{ Request::is('contact-masuk') ? 'active' : '' }}">
                        <a class="nav-link {{ Request::is('contact-masuk') ? 'active' : '' }}" href="/contact-masuk">
