            ...
            <div class="row justify-content-between mb-5">
                <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
                    <div class="img-about dots">
                        <img src="{{ asset('landing') }}/images/hero_bg_3.jpg" alt="Image" class="img-fluid" />
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="container">
            <div class="row justify-content-between mb-5">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="img-about dots">
                        <img src="{{ asset('landing') }}/images/hero_bg_2.jpg" alt="Image" class="img-fluid" />
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex feature-h">
                ...
                <div class="testimonial-slider">
                    <div class="item">
                        <div class="testimonial">
                            <img src="{{ asset('landing') }}/images/person_1-min.jpg" alt="Image"
                    ...
                    <div class="item">
                        <div class="testimonial">
                            <img src="{{ asset('landing') }}/images/person_3-min.jpg" alt="Image"
                                class="img-fluid rounded-circle w-25 mb-4" />
                    ...
                    <div class="item">
                        <div class="testimonial">
                            <img src="{{ asset('landing') }}/images/person_4-min.jpg" alt="Image"
                                class="img-fluid rounded-circle w-25 mb-4" />
