...
<div
      ...
      style="background-image: url('{{ asset('landing') }}/images/yamaha.jpg')"
    >
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">Testimoni</h1>
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('landing') }}/images/person_1-min.jpg"
                  alt="Image"
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('landing') }}/images/person_2-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('landing') }}/images/person_3-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{ asset('landing') }}/images/person_4-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
