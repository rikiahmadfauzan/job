...
@section('content')
    <div class="hero page-inner overlay" style="background-image: url('{{ asset('landing') }}/images/daihatsu.jpg')">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    <form action="/create/contact" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
